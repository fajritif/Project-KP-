...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->call(function () {
            ...
            $devices = Device::select("CAMERA_STREAMING")->distinct()->whereNotNull("CAMERA_STREAMING")->get();
            ...
            try {
                ...
                foreach ($devices as $device) {
                    if ($device->CAMERA_STREAMING) {
                        ...
                        $script = "ffmpeg -v verbose -rtsp_transport tcp -i $escapedUrl -vcodec libx264 -s 320x240 -r 25 -b:v 100k -crf 30 -acodec aac -sc_threshold 0 -f hls -hls_time 5 -segment_time 5 -hls_list_size 5 -hls_flags delete_segments D:/Projects/ptpn5/millena-holding-web/storage/app/streaming/$kode/stream.m3u8";
